...
var options = {
  ...
  headers: {
    ...
    'Authorization': 'Bearer p7CJ8JCmNrJ9jqQi65QVluPUOTX0c/mtfsjCanu4GPvB7OJuFhiDCje3R+e0xHdWxWcBohixEfubcWLTfwg51MFBZAYm7VvKHWq8ngUny+VUUhD8hOpLs8Q23IYUaT4eosM2Ihsea56mLfK3k8pWRwdB04t89/1O/w1cDnyilFU='
...
function parseInput(rplyToken, inputStr) {
        ...
        //鴨霸獸指令開始於此
        if (inputStr.match('SB') != null && inputStr.match('說明') != null) return randomReply() + '\n' + '\
總之你要擲骰前就先打roll，後面接像是2d6，1d6+3，2d6+1d3之類的就好。  \
\n要多筆輸出就是先空一格再打像是 *5 之類的。  \
\n不要打成大寫D，不要逼我嗆你 \
\n如果是CoC系的話，有初步支援cc擲骰了，獎懲骰也支援了。 \
';
        if (inputStr.match('SB') != null) return randomReply() ;
...
return countStr;
        ...
        function randomReply() {
          let rplyArr = ['你們死定了呃呃呃不要糾結這些……所以是在糾結哪些？', '在台灣，每過一分鐘就有一顆饅頭被。 \n我到底在共三小。', '嗚噁噁噁噁噁噁，不要隨便叫我。', '幹，你這學不會的豬！', '呱', 'wwwwwwwwwwwwwwwww', '叫我幹嘛?', '幹', '睡你麻痺 起來嗨！', '橘子是87'];
